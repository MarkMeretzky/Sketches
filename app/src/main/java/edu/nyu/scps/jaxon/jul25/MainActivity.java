...
public class MainActivity extends AppCompatActivity {
    ...
    private String databaseName = "gallery2.db";
    private String tableNameInv = "inventory";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new SimpleCursorAdapter(
                ...
                cursor,
                new String[] {"name",             "category",   "image"},
        ...
        adapter.setViewBinder(new SimpleCursorAdapter.ViewBinder() {
            ...
            //it will set the text of the TextView.

            @Override
            public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
                int imageIndex = cursor.getColumnIndex("image");
                if (columnIndex == imageIndex) {
                    String imageNumber = cursor.getString(imageIndex);
                    Resources resources = getResources();
                    String packageName = getPackageName();
                    int resId = resources.getIdentifier(imageNumber, "drawable", packageName);
                    ((ImageView)view).setImageResource(resId);
                    return true; //This method has written the text into the TextView.
                }
                return false;    //The text still needs to be written into the TextView.
            }
        });
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(final AdapterView<?> parent, View view, final int position, final long id) {
                ...
                //imageView.setImageResource(MainActivity.this.sample[position % sample.length]);
                ...
                builder.setNegativeButton(R.string.button_delete, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        database.delete(tableNameInv, "_id = ?", new String[] {Long.toString(id)});
                        ...
                        editText.setOnKeyListener(new View.OnKeyListener() {
                            ...
                            public boolean onKey(View v, int keyCode, KeyEvent event) {
                                if (event.getAction() == KeyEvent.ACTION_DOWN
                                    ...
                                    SQLiteDatabase database = helper.getWritableDatabase();
                                    database.update(tableNameInv, contentValues, "_id = ?", new String[] {Long.toString(id)});
                                    adapter.changeCursor(helper.getCursor());
                                    alertDialog.dismiss();
                                    return true;
                                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
            ...
            editText.setOnKeyListener(new View.OnKeyListener() {
                ...
                public boolean onKey(View v, int keyCode, KeyEvent event) {
                    if (event.getAction() == KeyEvent.ACTION_DOWN
                        ...
                        contentValues.put("name", editable.toString());
                        SQLiteDatabase database = helper.getWritableDatabase();
                        database.insert(tableNameInv, null, contentValues);
                        adapter.changeCursor(helper.getCursor());
                        alertDialog.dismiss();
                        return true;
                    }
        ...
        if (id == R.id.action_delete_all) {
            ...
            SQLiteDatabase database = helper.getWritableDatabase();
            database.delete(tableNameInv, null, null);
            adapter.changeCursor(helper.getCursor());
            return true;
        }
